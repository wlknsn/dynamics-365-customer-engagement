...
|  |Admin action  |
|---------|---------|
|You’re using Microsoft Dynamics CRM Online Spring ‘14 or later.     |None. You can skip the steps in this section. They apply only to on-premises Microsoft Dynamics 365.         |
|You’re using an on-premises version of Dynamics 365 that is earlier than Microsoft Dynamics CRM 2013 Service Pack 1 (SP1).     |Update to Microsoft Dynamics CRM 2013 Service Pack 1 (SP1) or later, and then follow the steps in this section.         |
